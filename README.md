...
![modelo_conceitual](Modelos/conceitual.jpeg)

  
![modelo lógico](Modelos/logico.png)

Em seguida, foram executadas com sucesso cinco _queries_ sobre o banco de dados obtido com os _datasets_ mencionados. As descrições destas buscas estão logo acima de suas implementações, em comentários no próprio _notebook_ do _Jupyer_.
